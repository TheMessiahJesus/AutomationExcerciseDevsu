Steps to Execute Automation Exercise Devsu, which contains the automation for exercise 1 and exercise 2. As well as its reports, 
and the excel document that contains the RTX matrix for exercise 1 and 2.
...
https://github.com/TheMessiahJesus/AutomationExcerciseDevsu
